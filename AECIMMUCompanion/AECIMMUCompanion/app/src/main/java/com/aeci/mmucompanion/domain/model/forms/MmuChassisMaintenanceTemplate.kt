...
/**
 * COMPREHENSIVE MMU Chassis Maintenance Record Template
 * Complete field coverage matching original PDF with precise coordinate mapping
 */
class MmuChassisMaintenanceTemplate : DigitalFormTemplate {
    
        override val templateId = "MMU_CHASSIS_MAINTENANCE"
    override val title = "MMU Chassis Maintenance Record"
    override val version = "1.0"
        override val formType = FormType.MMU_CHASSIS_MAINTENANCE
    override val pdfFileName = "MMU CHASSIS MAINTENANCE RECORD.pdf"
    ...
    override val staticTextCoordinates = listOf(
        StaticTextCoordinate(
            text = "MMU Chassis Maintenance Record".uppercase(),
    ...
    override fun getFormTemplate(): FormDefinition {
        return FormDefinition(
            id = templateId,
            name = title,
            description = "MmuChassisMaintenance form template",
            sections = listOf(
