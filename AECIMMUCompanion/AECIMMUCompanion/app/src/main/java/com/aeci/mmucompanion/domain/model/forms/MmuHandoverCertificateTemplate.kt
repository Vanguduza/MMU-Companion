...
/**
 * COMPREHENSIVE MMU Handover Certificate Template
 * Complete field coverage matching original PDF with precise coordinate mapping
 */
class MmuHandoverCertificateTemplate : DigitalFormTemplate {
    
        override val templateId = "MMU_HANDOVER_CERTIFICATE"
    override val title = "MMU Handover Certificate"
    override val version = "1.0"
        override val formType = FormType.MMU_HANDOVER_CERTIFICATE
    override val pdfFileName = "MMU HANDOVER CERTIFICATE.pdf"
    ...
    override val staticTextCoordinates = listOf(
        StaticTextCoordinate(
            text = "MMU Handover Certificate".uppercase(),
    ...
    override fun getFormTemplate(): FormDefinition {
        return FormDefinition(
            id = templateId,
            name = title,
            description = "MmuHandoverCertificate form template",
            sections = listOf(
