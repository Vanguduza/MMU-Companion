...
/**
 * COMPREHENSIVE On Bench MMU Inspection Template
 * Complete field coverage matching original PDF with precise coordinate mapping
 */
class OnBenchMmuInspectionTemplate : DigitalFormTemplate {
    
        override val templateId = "ON_BENCH_MMU_INSPECTION"
    override val title = "On Bench MMU Inspection"
    override val version = "1.0"
        override val formType = FormType.ON_BENCH_MMU_INSPECTION
    override val pdfFileName = "ON BENCH MMU INSPECTION.pdf"
    ...
    override val staticTextCoordinates = listOf(
        StaticTextCoordinate(
            text = "On Bench MMU Inspection".uppercase(),
    ...
    override fun getFormTemplate(): FormDefinition {
        return FormDefinition(
            id = templateId,
            name = title,
            description = "OnBenchMmuInspection form template",
            sections = listOf(
