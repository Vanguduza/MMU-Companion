...
/**
 * COMPREHENSIVE Monthly Process Maintenance Record Template
 * Complete field coverage matching original PDF with precise coordinate mapping
 */
class MonthlyProcessMaintenanceTemplate : DigitalFormTemplate {
    
        override val templateId = "MONTHLY_PROCESS_MAINTENANCE"
    override val title = "Monthly Process Maintenance Record"
    override val version = "1.0"
        override val formType = FormType.MONTHLY_PROCESS_MAINTENANCE
    override val pdfFileName = "MONTHLY PROCESS MAINTENANCE RECORD.pdf"
    ...
    override val staticTextCoordinates = listOf(
        StaticTextCoordinate(
            text = "Monthly Process Maintenance Record".uppercase(),
    ...
    override fun getFormTemplate(): FormDefinition {
        return FormDefinition(
            id = templateId,
            name = title,
            description = "MonthlyProcessMaintenance form template",
            sections = listOf(
